...
The methods differ in their approach to cycle detection and handling of the first
turning point, which leads to different cycle counts when a cycle range includes
