...
This implementation supports multiple counting methods, including the 4-point
method (DIN 45667 / FVA-Richtlinie) and the 3-point method (ASTM E 1049).
...
The two standards use different cycle detection algorithms (4-point vs. 3-point),
which can produce different cycle counts during normal processing — not only in
residue handling. A further critical difference exists in how each standard treats
the residue (the unclosed signal stream remaining at the end of the counting process).
