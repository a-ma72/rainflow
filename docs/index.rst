...
**Performance Optimization**
   ...
   - `features.rst <features.rst>`_ - Feature selection (disable unused features)
   - `delegates.rst <delegates.rst>`_ - Custom allocators and lookup tables
...
**Damage History**
   ...
   apply a prefix sum (``np.cumsum``) to obtain cumulative damage over time
