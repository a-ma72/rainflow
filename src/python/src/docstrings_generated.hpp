...
inline constexpr const char* AT_TRANSFORM_DOC = R"rfcnt_doc(
Amplitude transformation (mean stress correction, Haigh diagram).
...
inline constexpr const char* DAMAGE_FROM_RP_DOC = R"rfcnt_doc(
...
inline constexpr const char* RFC_DOC = R"rfcnt_doc(
Rainflow counting.
